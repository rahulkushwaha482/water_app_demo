                ...
                Obx(
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: controller.searchCityResponse.value.data!
                              .record!.length ?? 1,
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: (){
                                controller.getCityName(controller.searchCityResponse.value.data!.record![index].name.toString());
                                Get.back();
                              },
                              child: SizedBox(
                                height: 50,
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(controller.searchCityResponse.value.data!
                                          .record![index].name.toString() ?? "df",
                                        style:TextStyle(fontSize: 18),),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(left: 10.0),
                                      child: Text(controller.searchCityResponse.value.data!
                                          .record![index].country.toString() ??
                                          "sdf",style: TextStyle(fontSize: 10),),
                                    ),
                                    Divider(thickness: 1,color: AppTheme.kDarkBlue,)
                                  ],
                                ),
                              ),
                            );
